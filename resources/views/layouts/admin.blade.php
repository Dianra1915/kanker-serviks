...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
            ...
            <div class="sidebar-brand-text mx-3 text-white" style="font-weight: 700; font-size: 0.9rem; text-align: left;">
                RSIA BUDI MEDIKA
            </div>
        </a>
        ...
        @if(Auth::user()->role == 'admin')
            <div class="sidebar-heading">{{ __('Manajemen Pakar') }}</div>
            <li class="nav-item">
                <a class="nav-link" href="/gejala">
                    <i class="fas fa-fw fa-notes-medical"></i>
                    <span>{{ __('Data Gejala') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/jenis">
                    <i class="fas fa-fw fa-skull-crossbones"></i>
                    <span>{{ __('Jenis Kanker') }}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/rules">
                    <i class="fas fa-fw fa-project-diagram"></i>
                    <span>{{ __('Aturan (Rule)') }}</span>
                </a>
            </li>
        @endif

        <div class="sidebar-heading">{{ __('Layanan') }}</div>
        <li class="nav-item {{ Nav::isRoute('konsultasi') }}">
            <a class="nav-link" href="/konsultasi">
                <i class="fas fa-fw fa-stethoscope"></i>
                <span>{{ __('Konsultasi') }}</span>
            </a>
        </li>
        <li class="nav-item {{ Nav::isRoute('riwayat') }}">
            <a class="nav-link" href="/riwayat">
                <i class="fas fa-fw fa-history"></i>
                <span>{{ __('Riwayat Konsultasi') }}</span>
            </a>
        </li>
